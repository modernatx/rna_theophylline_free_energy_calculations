...
# cmpnd_list = ['2-theophylline', '5-hypoxanthine']
cond_list = ['3-55KCl_3Mg/1-40winCmplx_30winLig']
# rep_list = [ '1-rep1', '2-rep2', '3-rep3']
## output file
with open('results/BFE_with_failed/55_KCl_3Mg_TP3_GAF_40_1ns_unres_2.txt', 'w') as f:
    sys.stdout = f
