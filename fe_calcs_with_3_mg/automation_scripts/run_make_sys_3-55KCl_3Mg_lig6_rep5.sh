...
dir_list1="6-xanthine" #" 3-1_methylxanthine 4-3_methylxanthine 5-hypoxanthine 6-xanthine 7-caffeine"
#dir_list2=" 2-theophylline "
cond_list="3-55KCl_3Mg"
rep_list="5-rep5" #"1-rep1 2-rep2 3-rep3 4-rep4"
...
for val1 in $dir_list1; do
    ...
    for val2 in $cond_list; do
        ...
        for val3 in $rep_list; do
            ...
            cd ${val3}/
            echo ${val3}
            cp -r ../../../1-55NaCl_3Mg/1-40winCmplx_30winLig/2-rep2/0-starting_PDB .
            mkdir -p 1-sys_prep
            cd 1-sys_prep
            cp ../../../../1-55NaCl_3Mg/1-40winCmplx_30winLig/2-rep2/1-sys_prep/*tcl .
            cp ../../../../1-55NaCl_3Mg/1-40winCmplx_30winLig/2-rep2/1-sys_prep/*sh .
            cp ../../../../1-55NaCl_3Mg/1-40winCmplx_30winLig/2-rep2/1-sys_prep/tleap.in .
            cp ../../../../1-55NaCl_3Mg/1-40winCmplx_30winLig/2-rep2/1-sys_prep/*py .
            cp ../../../../1-55NaCl_3Mg/1-40winCmplx_30winLig/2-rep2/1-sys_prep/*pdb .
            ...
            cd 2-sim_run
            cp -r ../../../../1-55NaCl_3Mg/1-40winCmplx_30winLig/2-rep2/2-sim_run/equ_0/*conf equ_0
            cp -r ../../../../1-55NaCl_3Mg/1-40winCmplx_30winLig/2-rep2/2-sim_run/equ_1/*conf equ_1
            cp -r ../../../../1-55NaCl_3Mg/1-40winCmplx_30winLig/2-rep2/2-sim_run/equ_2/*conf equ_2
            cp -r ../../../../1-55NaCl_3Mg/1-40winCmplx_30winLig/2-rep2/2-sim_run/restraints .
