...
complex_structure.coordinates = orig_structure.split()[1:].coordinates
complex_structure.box_vectors = orig_structure.split()[1:].box_vectors
orig_structure.split()[1:]

# Export the Structure to AMBER files
complex_structure.save("ligOnly.prmtop", overwrite=True)
complex_structure.save("ligOnly.inpcrd", overwrite=True)
complex_structure.save("ligOnly.pdb", overwrite=True)