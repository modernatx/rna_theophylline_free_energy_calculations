...
for val1 in $dir_list1; do
    ...
    for val2 in $cond_list; do
        ...
        for val3 in $rep_list; do
            ...
            cp -r ../../../1-55NaCl_2Mg/1-40win/1-rep1/0-starting_PDB .
    
            # Copy 1-sys_prep files
            mkdir -p 1-sys_prep
            cd 1-sys_prep
            cp ../../../../1-55NaCl_2Mg/1-40win/1-rep1/1-sys_prep/*tcl .
            cp ../../../../1-55NaCl_2Mg/1-40win/1-rep1/1-sys_prep/*sh .
            cp ../../../../1-55NaCl_2Mg/1-40win/1-rep1/1-sys_prep/tleap.in .
            cp ../../../../1-55NaCl_2Mg/1-40win/1-rep1/1-sys_prep/*py .
            cp ../../../../1-55NaCl_2Mg/1-40win/1-rep1/1-sys_prep/*pdb .
            ...
            cd 2-sim_run
            cp -r ../../../../1-55NaCl_2Mg/1-40win/1-rep1/2-sim_run/equ_0/*conf equ_0
            cp -r ../../../../1-55NaCl_2Mg/1-40win/1-rep1/2-sim_run/equ_1/*conf equ_1
            # Equ_2 doesn't exist for equilibration with backbone restraints
            #cp -r ../../../../1-55NaCl_2Mg/1-40win/1-rep1/2-sim_run/equ_2/*conf equ_2
            ...
            cp -r ../../../../1-55NaCl_2Mg/1-40win/1-rep1/2-sim_run/restraints .
            ...
            cp -r ../../../../../1-55NaCl_2Mg/1-40win/1-rep1/2-sim_run/contribution_RMSD_ref_wrap/*.in .
            cp -r ../../../../../1-55NaCl_2Mg/1-40win/1-rep1/2-sim_run/contribution_RMSD_ref_wrap/*.conf .
            cp -r ../../../../../../common_files/gen_index_group_MI.tcl .
            cp -r ../../../../../1-55NaCl_2Mg/1-40win/1-rep1/2-sim_run/contribution_RMSD/*.py .
            mkdir -p output
