...
axs.hlines(2, 0, 80,colors='k', linestyles='dashed', label='', alpha=.3, linewidth=1) # Add a horizontal line at 2
...
fig.text(0.04, 0.475, r'P$_{fwd}$($\Delta$U)', va='center', rotation='vertical', fontsize=24, color="r") 
fig.text(0.04, 0.5,',', va='center', rotation='vertical', fontsize=24)
fig.text(0.04, 0.53,r'P$_{bwd}$($\Delta$U)', va='center', rotation='vertical', fontsize=24, color="b")
fig.text(0.5, 0.08, r'$\Delta$U (kcal/mol)', ha='center', fontsize=24)
...
fig.suptitle(r"$<D_{KL}>=$%2.1f" %np.mean(kl), fontsize=36, y=.91)
