...
Uses the parmed.openmm.load_topology() function to create a parmed.Structure object from the Topology object and the OpenMM system.
10-Saves the new parmed.Structure object as a new AMBER topology and coordinate file.
'''
import argparse
