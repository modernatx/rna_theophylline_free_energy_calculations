...
C = 0.5
fig, ax = plt.subplots()
plt.plot(t1 * C, x1[:,1], linewidth = 1, color = 'tab:blue', label = 'RNA backbone')
plt.plot(t1 * C, x2[:,1], linewidth = 1, color = 'tab:red', label = 'ligand')
...
ax.add_patch(Rectangle((0,0),214*C,30, facecolor = 'cornsilk', alpha = 0.3))
ax.add_patch(Rectangle((214*C,0),20*C,30, facecolor = 'sandybrown', alpha = 0.3))
ax.add_patch(Rectangle(((214+20)*C,0),160*C,30, facecolor = 'lavender', alpha = 0.3))
ax.add_patch(Rectangle(((214+20+160)*C,0),164*C,30, facecolor = 'pink', alpha = 0.3))
