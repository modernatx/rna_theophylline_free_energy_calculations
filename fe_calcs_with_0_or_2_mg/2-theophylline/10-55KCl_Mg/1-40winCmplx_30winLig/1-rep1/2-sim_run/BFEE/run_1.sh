...
/home/arasouli/opt/NAMD_3.0alpha13_Linux-x86_64-multicore-CUDA/namd3 +p12 002.1_ti_backward.conf > 002.1_ti_backward.log &
pids[2]=$!

cd ../003_MoleculeUnbound/
date +"%D %T" > 003.1_fep_backward.start.time
/home/arasouli/opt/NAMD_3.0alpha13_Linux-x86_64-multicore-CUDA/namd3 +p4 003.1_fep_backward.conf > 003.1_fep_backward.log &
pids[3]=$!

cd ../004_RestraintUnbound/
date +"%D %T" > 004.1_ti_backward.start.time
/home/arasouli/opt/NAMD_3.0alpha13_Linux-x86_64-multicore-CUDA/namd3 +p4 004.1_ti_backward.conf > 004.1_ti_backward.log &
pids[4]=$!
...
cd ../002_RestraintBound/
/home/arasouli/opt/NAMD_3.0alpha13_Linux-x86_64-multicore-CUDA/namd3 +p12 002.2_ti_forward.conf > 002.2_ti_forward.log &
date +"%D %T" > 002.2_ti_forward.start.time

cd ../003_MoleculeUnbound/
/home/arasouli/opt/NAMD_3.0alpha13_Linux-x86_64-multicore-CUDA/namd3 +p4 003.2_fep_forward.conf > 003.2_fep_forward.log &
date +"%D %T" > 003.2_fep_forward.start.time

cd ../004_RestraintUnbound/
/home/arasouli/opt/NAMD_3.0alpha13_Linux-x86_64-multicore-CUDA/namd3 +p4 004.2_ti_forward.conf  > 004.2_ti_forward.log &
