...
ax.add_patch(Rectangle((0,0),209*C,30, facecolor = 'bisque', alpha = 0.3))
ax.add_patch(Rectangle((209*C,0),20*C,30, facecolor = 'rosybrown', alpha = 0.3))
ax.add_patch(Rectangle(((209+20)*C,0),160*C,30, facecolor = 'lavender', alpha = 0.3))
ax.add_patch(Rectangle(((209+20+160)*C,0),164*C,30, facecolor = 'lightpink', alpha = 0.3))
...
plt.xlim((0, (209+20+160+164)*C))   # set the xlim to left, right
